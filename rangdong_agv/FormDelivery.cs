...
namespace rangdong_agv
{
    ...
    {      
        ...
        private void btnStartAgv_Click(object sender, EventArgs e)
        {
            //Trạm D01 (Kí hiệu: 07, STT: 1)
            //AGV1
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "1") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "1")))
            {
                byte[] output = new byte[] { 0x7A, 0x23, 0x01, 0x01, 0xFE, 0x00, 0x01, 0x01, 0x1A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x06, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }

            //AGV2
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "1") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "1")))
            {
                byte[] output = new byte[] { 0x7A, 0x23, 0x01, 0x02, 0xFE, 0x00, 0x01, 0x01, 0x1A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x06, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "1") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "1")))
            {
                byte[] output = new byte[] { 0x7A, 0x23, 0x01, 0x03, 0xFE, 0x00, 0x01, 0x01, 0x1A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x06, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "2") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "2")))
            {
                byte[] output = new byte[] { 0x7A, 0x27, 0x01, 0x01, 0xFE, 0x00, 0x02, 0x01, 0x1E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x06, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "2") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "2")))
            {
                byte[] output = new byte[] { 0x7A, 0x27, 0x01, 0x02, 0xFE, 0x00, 0x02, 0x01, 0x1E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x06, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "2") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "2")))
            {
                byte[] output = new byte[] { 0x7A, 0x27, 0x01, 0x03, 0xFE, 0x00, 0x02, 0x01, 0x1E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x06, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "3") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "3")))
            {
                byte[] output = new byte[] { 0x7A, 0x2B, 0x01, 0x01, 0xFE, 0x00, 0x03, 0x01, 0x22, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x06, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "3") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "3")))
            {
                byte[] output = new byte[] { 0x7A, 0x2B, 0x01, 0x02, 0xFE, 0x00, 0x03, 0x01, 0x22, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x06, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "3") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "3")))
            {
                byte[] output = new byte[] { 0x7A, 0x2B, 0x01, 0x03, 0xFE, 0x00, 0x03, 0x01, 0x22, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x06, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "4") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "4")))
            {
                byte[] output = new byte[] { 0x7A, 0x2F, 0x01, 0x01, 0xFE, 0x00, 0x04, 0x01, 0x26, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x06, 0x0A, 0x06, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "4") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "4")))
            {
                byte[] output = new byte[] { 0x7A, 0x2F, 0x01, 0x02, 0xFE, 0x00, 0x04, 0x01, 0x26, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x06, 0x0A, 0x06, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "4") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "4")))
            {
                byte[] output = new byte[] { 0x7A, 0x2F, 0x01, 0x03, 0xFE, 0x00, 0x04, 0x01, 0x26, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x06, 0x0A, 0x06, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "5") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "5")))
            {
                byte[] output = new byte[] { 0x7A, 0x33, 0x01, 0x01, 0xFE, 0x00, 0x05, 0x01, 0x2A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x02, 0x0B, 0x06, 0x0B, 0x06, 0x0A, 0x02, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "5") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "5")))
            {
                byte[] output = new byte[] { 0x7A, 0x33, 0x01, 0x02, 0xFE, 0x00, 0x05, 0x01, 0x2A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x02, 0x0B, 0x06, 0x0B, 0x06, 0x0A, 0x02, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "5") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "5")))
            {
                byte[] output = new byte[] { 0x7A, 0x33, 0x01, 0x03, 0xFE, 0x00, 0x05, 0x01, 0x2A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x02, 0x0B, 0x06, 0x0B, 0x06, 0x0A, 0x02, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "6") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "6")))
            {
                byte[] output = new byte[] { 0x7A, 0x37, 0x01, 0x01, 0xFE, 0x00, 0x06, 0x01, 0x2E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x02, 0x0B, 0x02, 0x0C, 0x06, 0x0C, 0x06, 0x0B, 0x02, 0x0A, 0x02, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "6") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "6")))
            {
                byte[] output = new byte[] { 0x7A, 0x37, 0x01, 0x02, 0xFE, 0x00, 0x06, 0x01, 0x2E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x02, 0x0B, 0x02, 0x0C, 0x06, 0x0C, 0x06, 0x0B, 0x02, 0x0A, 0x02, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "6") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "6")))
            {
                byte[] output = new byte[] { 0x7A, 0x37, 0x01, 0x03, 0xFE, 0x00, 0x06, 0x01, 0x2E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x02, 0x0B, 0x02, 0x0C, 0x06, 0x0C, 0x06, 0x0B, 0x02, 0x0A, 0x02, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "7") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "7")))
            {
                byte[] output = new byte[] { 0x7A, 0x3B, 0x01, 0x01, 0xFE, 0x00, 0x07, 0x01, 0x32, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x02, 0x0B, 0x02, 0x0C, 0x02, 0x0D, 0x06, 0x0D, 0x06, 0x0C, 0x02, 0x0B, 0x02, 0x0A, 0x02, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "7") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "7")))
            {
                byte[] output = new byte[] { 0x7A, 0x3B, 0x01, 0x02, 0xFE, 0x00, 0x07, 0x01, 0x32, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x02, 0x0B, 0x02, 0x0C, 0x02, 0x0D, 0x06, 0x0D, 0x06, 0x0C, 0x02, 0x0B, 0x02, 0x0A, 0x02, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "7") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "7")))
            {
                byte[] output = new byte[] { 0x7A, 0x3B, 0x01, 0x03, 0xFE, 0x00, 0x07, 0x01, 0x32, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x05, 0x02, 0x07, 0x02, 0x08, 0x02, 0x09, 0x02, 0x0A, 0x02, 0x0B, 0x02, 0x0C, 0x02, 0x0D, 0x06, 0x0D, 0x06, 0x0C, 0x02, 0x0B, 0x02, 0x0A, 0x02, 0x09, 0x02, 0x08, 0x02, 0x07, 0x02, 0x05, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "8") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "8")))
            {
                byte[] output = new byte[] { 0x7A, 0x23, 0x01, 0x01, 0xFE, 0x00, 0x08, 0x01, 0x1A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x06, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "8") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "8")))
            {
                byte[] output = new byte[] { 0x7A, 0x23, 0x01, 0x02, 0xFE, 0x00, 0x08, 0x01, 0x1A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x06, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "8") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "8")))
            {
                byte[] output = new byte[] { 0x7A, 0x23, 0x01, 0x03, 0xFE, 0x00, 0x08, 0x01, 0x1A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x06, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "9") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "9")))
            {
                byte[] output = new byte[] { 0x7A, 0x27, 0x01, 0x01, 0xFE, 0x00, 0x09, 0x01, 0x1E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x06, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "9") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "9")))
            {
                byte[] output = new byte[] { 0x7A, 0x27, 0x01, 0x02, 0xFE, 0x00, 0x09, 0x01, 0x1E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x06, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "9") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "9")))
            {
                byte[] output = new byte[] { 0x7A, 0x27, 0x01, 0x03, 0xFE, 0x00, 0x09, 0x01, 0x1E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x06, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "10") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "10")))
            {
                byte[] output = new byte[] { 0x7A, 0x2B, 0x01, 0x01, 0xFE, 0x00, 0x03, 0x01, 0x22, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x06, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "10") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "10")))
            {
                byte[] output = new byte[] { 0x7A, 0x2B, 0x01, 0x02, 0xFE, 0x00, 0x03, 0x01, 0x22, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x06, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "10") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "10")))
            {
                byte[] output = new byte[] { 0x7A, 0x2B, 0x01, 0x03, 0xFE, 0x00, 0x03, 0x01, 0x22, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x06, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "11") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "11")))
            {
                byte[] output = new byte[] { 0x7A, 0x2F, 0x01, 0x01, 0xFE, 0x00, 0x04, 0x01, 0x26, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x06, 0xC4, 0x06, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "11") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "11")))
            {
                byte[] output = new byte[] { 0x7A, 0x2F, 0x01, 0x02, 0xFE, 0x00, 0x04, 0x01, 0x26, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x06, 0xC4, 0x06, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "11") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "11")))
            {
                byte[] output = new byte[] { 0x7A, 0x2F, 0x01, 0x03, 0xFE, 0x00, 0x04, 0x01, 0x26, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x06, 0xC4, 0x06, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "12") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "12")))
            {
                byte[] output = new byte[] { 0x7A, 0x33, 0x01, 0x01, 0xFE, 0x00, 0x05, 0x01, 0x2A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x02, 0xC5, 0x06, 0xC5, 0x06, 0xC4, 0x02, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "12") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "12")))
            {
                byte[] output = new byte[] { 0x7A, 0x33, 0x01, 0x02, 0xFE, 0x00, 0x05, 0x01, 0x2A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x02, 0xC5, 0x06, 0xC5, 0x06, 0xC4, 0x02, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }

            //AGV3
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "12") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "12")))
            {
                byte[] output = new byte[] { 0x7A, 0x33, 0x01, 0x03, 0xFE, 0x00, 0x05, 0x01, 0x2A, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x02, 0xC5, 0x06, 0xC5, 0x06, 0xC4, 0x02, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "13") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "13")))
            {
                byte[] output = new byte[] { 0x7A, 0x37, 0x01, 0x01, 0xFE, 0x00, 0x06, 0x01, 0x2E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x02, 0xC5, 0x02, 0xC6, 0x06, 0xC6, 0x02, 0xC5, 0x02, 0xC4, 0x02, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv2.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "13") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "13")))
            {
                byte[] output = new byte[] { 0x7A, 0x37, 0x01, 0x02, 0xFE, 0x00, 0x06, 0x01, 0x2E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x02, 0xC5, 0x02, 0xC6, 0x06, 0xC6, 0x02, 0xC5, 0x02, 0xC4, 0x02, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv3.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "13") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "13")))
            {
                byte[] output = new byte[] { 0x7A, 0x37, 0x01, 0x03, 0xFE, 0x00, 0x06, 0x01, 0x2E, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x02, 0xC5, 0x02, 0xC6, 0x06, 0xC6, 0x02, 0xC5, 0x02, 0xC4, 0x02, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
            ...
            if (radioButtonAgv1.Checked == true && ((comboBoxFeedingStation1.Text == "1" && labelFeedingDeliveryStation1.Text == "14") || (comboBoxFeedingStation2.Text == "1" && labelFeedingDeliveryStation2.Text == "14")))
            {
                byte[] output = new byte[] { 0x7A, 0x3B, 0x01, 0x01, 0xFE, 0x00, 0x07, 0x01, 0x32, 0x01, 0x01, 0x02, 0x02, 0x07, 0x03, 0x02, 0x04, 0x03, 0x06, 0x02, 0xC1, 0x02, 0xC2, 0x02, 0xC3, 0x02, 0xC4, 0x02, 0xC5, 0x02, 0xC6, 0x02, 0xC7, 0x06, 0xC7, 0x02, 0xC6, 0x02, 0xC5, 0x02, 0xC4, 0x02, 0xC3, 0x02, 0xC2, 0x02, 0xC1, 0x02, 0x06, 0x02, 0x04, 0x02, 0x03, 0x01, 0x02, 0x01, 0x01, 0x09, 0x7F };
                comport1.Write(output, 0, output.Length);
            }
